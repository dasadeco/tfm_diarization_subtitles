## Copied from https://github.com/X-LANCE/BER/blob/master/score.py and modified to fit our minimum requirements
## X-LANCE is one of the repositories from SJTU Cross Media Language Intelligence Lab based in Shanghai and Beijing
##
## We thanks them to provide us with this code to calculate BER and SER
import os
...
def get_jer_ser_ber(ref_rttm_file, hyp_rttm_file):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-hyp', dest='hyp_rttm_fns', help='system RTTM files (default: %(default)s)')
    parser.add_argument('-ref', dest='ref_rttm_fns', help='reference RTTM files (default: %(default)s)')
